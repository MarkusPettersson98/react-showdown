 ...
 */
module.exports = Converter = (options) => {
	'use strict';
	var self = this;
	...
	this._converter.listen('tables.after', (_, text) => {
		var result = text;
	...
	this._mapElements = (elements) => {
		var children = React.Children.toArray(elements.map((element) => {
